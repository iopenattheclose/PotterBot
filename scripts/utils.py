...
def load(path_or_hf_repo: str, tokenizer_config={}):
    ...
    # model_path = Path("mlx-community/Mistral-7B-Instruct-v0.2-4bit")
    ...
    model_path = "/Users/prupro/.cache/huggingface/hub/models--mlx-community--Mistral-7B-Instruct-v0.2-4bit/snapshots/64481e3a4a7bb0990c45c991958f8d6c00c1e785/"
